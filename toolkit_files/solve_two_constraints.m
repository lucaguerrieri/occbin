function [zdata zdataconcatenated M00_ oo00_] = solve_two_constraints(modnam_00,modnam_10,modnam_01,modnam_11,...
    constraint1, constraint2,...
    constraint_relax1, constraint_relax2,...
    scalefactormod,irfshock,nperiods,curb_retrench,tol0,maxiter)
...
% solve model
eval(['dynare ',modnam_00,' noclearall'])
oo00_ = oo_;
M00_ = M_;
setss
...
[hm1,h,hl1,Jbarmat] = get_deriv(M00_,ys_);
cof = [hm1,h,hl1];


M10_.params = M00_.params;
[hm1,h,hl1,Jbarmat10,resid] = get_deriv(M10_,ys_);
cof10 = [hm1,h,hl1];
Dbarmat10 = resid;

M01_.params = M00_.params;
[hm1,h,hl1,Jbarmat01,resid] = get_deriv(M01_,ys_);
cof01 = [hm1,h,hl1];
Dbarmat01 = resid;

M11_.params = M00_.params;
[hm1,h,hl1,Jbarmat11,resid] = get_deriv(M11_,ys_);
cof11 = [hm1,h,hl1];
Dbarmat11 = resid;
...
for ishock = 1:nshocks
    ...
    while (changes & iter<maxiter)
        ...
        [zdata]=mkdatap_anticipated_2constraints_alt(nperiods,decrulea,decruleb,...
            cof,Jbarmat,...
